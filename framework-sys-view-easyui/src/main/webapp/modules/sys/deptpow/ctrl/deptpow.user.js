define(function(require) {
	...
	var UnitInfoUserAdd = require('../ctrl/deptpow.user.add');
	var UnitInfoUserEdit = require('../ctrl/deptpow.user.edit');
	var UnitInfoUserRemove = require('../ctrl/deptpow.user.remove');
