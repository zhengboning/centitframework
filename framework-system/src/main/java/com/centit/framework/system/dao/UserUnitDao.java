...
/*        
    ...
    @Transactional
    public List<UserUnit> listUserUnitByIds(List<String> ids) {
        return (List<UserUnit>)  
                this.getCurrentSession().createCriteria(UserUnit.class).
                    add(Restrictions.in("id", ids)).list();
/*               return (List<UserUnit>) super.getHibernateTemplate().findByCriteria(DetachedCriteria.forClass(UserUnit.class)
