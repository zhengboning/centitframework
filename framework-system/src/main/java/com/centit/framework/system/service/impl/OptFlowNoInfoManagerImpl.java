...
public class OptFlowNoInfoManagerImpl extends
        BaseEntityManagerImpl<OptFlowNoInfo, OptFlowNoInfoId, OptFlowNoInfoDao> implements OptFlowNoInfoManager {
    ...
    @Resource(name = "optFlowNoInfoDao")
    @NotNull
    public synchronized  void setOptFlowNoInfoDao(OptFlowNoInfoDao baseDao) {
