...
public class MainFrameController extends BaseController {
    ...
    public void getMenu(HttpServletRequest request, HttpServletResponse response) {
        ...
        List<? extends IOptInfo> menuFunsByUser = platformEnvironment.
        			listUserMenuOptInfos(userDetails.getUserCode(), asAdmin);
    ...
    @RequestMapping(value ="/escapelogin/{userCode}",method = RequestMethod.GET)
    public void escapeLogin(@PathVariable String userCode, 
            HttpServletRequest request,HttpServletResponse response) {
    	CentitUserDetails ud = userDetailsService.loadDetailsByUserCode(userCode);
    	SecurityContextHolder.getContext().setAuthentication(ud);
    	JsonResultUtils.writeErrorMessageJson("用户"+ud.getUserName()+"跳过登录！", response);
    }*/
