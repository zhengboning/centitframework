...
public class DataPowerFilter {
	...
	public static Map<String,Map<String,String>> getHqlMetaData(){
		if(hqlMetaData==null){
	    	...
	    	Map<String, ClassMetadata> cm = sessionFactory.getAllClassMetadata();
	    	for(Map.Entry<String, ClassMetadata> ent : cm.entrySet()){
	    		Map<String,String> metaData = new HashMap<String,String>();
	    		String className = ent.getKey();
	    		String shortClassName = className.substring(className.lastIndexOf(".")+1);	    		
	    		Class<?> poClass =  ent.getValue().getMappedClass();	    		
